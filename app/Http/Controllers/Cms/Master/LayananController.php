...
class LayananController extends Controllermaster
{
    public function __construct()
    {

        $this->model = new Layanan;
        $this->primaryKey = 'layId';
        $this->mainroute = 'mslayanan';
    ...
    public function index()
    {
        ...
        if (trim(Session::get('email')) == '' or $this->checkRouteAuth() == 2) {
            ...
            $data = array(
                ...
                'page_tittle' => 'Master Layanan',
                'page_active' => 'Master Layanan',
                'grid' => $this->grid,
                'form' => $this->form,
                'listdata' => $listdata,
