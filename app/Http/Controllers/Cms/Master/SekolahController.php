...
class SekolahController extends Controllermaster
{
    public function __construct()
    {

        $this->model = new Sekolah;
        $this->primaryKey = 'sekId';
        $this->mainroute = 'mssekolah';
    ...
    public function index()
    {
        ...
        if (trim(Session::get('email')) == '' or $this->checkRouteAuth() == 2) {
            ...
            $data = array(
                ...
                'page_tittle' => 'Master Pendidikan',
                'page_active' => 'Master Pendidikan',
                'grid' => $this->grid,
                'form' => $this->form,
                'listdata' => $listdata,
